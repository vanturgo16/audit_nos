                    ...
                    <div class="card-header">
                        <div class="row">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <input class="form-control" name="department_name" type="text" value="" placeholder="Input Department Name.." required>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-4 d-flex justify-content-center align-items-center">
                                <h4 class="mb-sm-0 font-size-18">Master Departments</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
