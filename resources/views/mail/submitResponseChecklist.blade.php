...
<body>
    ...
    <p style="margin:0 0 8px 0;">
        Kami Ingin menginformasikan Anda bahwa Kami telah menyelesaikan audit checklist yang diserahkan.
        <span class="en">We would like to inform you that we already finish submitted checklist audit.</span>
    </p>
    <p style="margin:0 0 8px 0;">
        Mohon untuk ditinjau pada checklist dengan detail sebagai berikut:
        <span class="en">Please kindly review for the checklist as per the details below:</span>
    </p>
    ...
    <p>
        {{ $emailSubmitter }}<br>
        [Person In Charge Internal Auditor]
    </p>
</body>
</html>