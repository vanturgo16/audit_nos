...
<body>
    ...
    <p style="margin:0 0 8px 0;">
        Kami ingin menginformasikan Anda bahwa kami telah menetapkan audit checklist.
        <span class="en">We would like to inform you that we have assigned a checklist audit.</span>
    </p>
    <p style="margin:0 0 8px 0;">
