                    ...
                    @if(Auth::user()->role == 'Internal Auditor Dealer')
                        <div class="page-title-left">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('auditor.periodDetail', encrypt($periodInfo->id)) }}">Detail {{ $periodInfo->period }}</a></li>
                                <li class="breadcrumb-item active">Log Activity</li>
                            </ol>
                        </div>
                        <div class="page-title-right">
                            <a id="backButton" type="button" href="{{ route('auditor.periodDetail', encrypt($periodInfo->id)) }}" class="btn btn-sm btn-secondary waves-effect btn-label waves-light">
                    ...
                    @else 
                        <div class="page-title-left">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('review.periodDetail', encrypt($periodInfo->id)) }}">Detail {{ $periodInfo->period }}</a></li>
                                <li class="breadcrumb-item active">Log Activity</li>
                            </ol>
                        </div>
                        <div class="page-title-right">
                            <a id="backButton" type="button" href="{{ route('review.periodDetail', encrypt($periodInfo->id)) }}" class="btn btn-sm btn-secondary waves-effect btn-label waves-light">
                                <i class="mdi mdi-arrow-left-circle label-icon"></i> Back
                            </a>
                        </div>
                    @endif
