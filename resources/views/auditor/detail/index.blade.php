...
<div class="page-content">
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        @if(in_array($role, ['Super Admin', 'Internal Auditor Dealer']))
                            <a id="backButton" type="button" href="{{ route('auditor.periodList') }}"
                                class="btn btn-sm btn-secondary waves-effect btn-label waves-light">
                                <i class="mdi mdi-arrow-left-circle label-icon"></i>
                                Back
                            </a>
                        @elseif($role == 'Assessor Main Dealer')
                            <a id="backButton" type="button" href="{{ route('assessor.periodList') }}"
                                class="btn btn-sm btn-secondary waves-effect btn-label waves-light">
                                <i class="mdi mdi-arrow-left-circle label-icon"></i>
                                Back
                            </a>
        ...
        <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">:
                                ...
                                @else
                                    <span class="badge bg-warning text-white"><i class="mdi mdi-timer-alert-outline label-icon"></i> Expired - Contact Your Assessor</span>
                                @endif
                            </td>
                        </tr>
            ...
            <div class="col-12">
                <div class="card">
                    @if(in_array(Auth::user()->role, ['Super Admin', 'Internal Auditor Dealer']))
                    @if($allComplete == 1 && in_array($periodInfo->status, [1, 2]))
                        <div class="card-header">
                            <button type="button" class="btn btn-success waves-effect btn-label waves-light float-end" data-bs-toggle="modal" data-bs-target="#submit"><i class="mdi mdi-check-bold label-icon"></i>Submit Checklist</button>
                            {{-- Modal Submit --}}
                    ...
                    @if($allReviewed == 1 && in_array($periodInfo->status, [3]))
                        <div class="card-header">
                            <button type="button" class="btn btn-success waves-effect btn-label waves-light float-end" data-bs-toggle="modal" data-bs-target="#submit"><i class="mdi mdi-check-bold label-icon"></i>Submit Review</button>
                            {{-- Modal Submit --}}
                            <div class="modal fade" id="submit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-top" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('assessor.submitReviewChecklist', encrypt($id)) }}" id="formsubmit" method="POST">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="row p-4">
                                                    <div class="col-12 text-center">
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (row.status === "" || row.status === null) {
                            ...
                            html = '<span class="badge bg-success text-white"><i class="mdi mdi-check-circle-outline label-icon"></i> Checklist Approve</span>';
