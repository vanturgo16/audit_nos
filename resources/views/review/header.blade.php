...
<div class="row">
    ...
    @if($checkJar->last_correction_assessor === 0 && Auth::user()->id == $period->id_assesor)
    ...
    <div class="col-lg-12">
        <table class="table table-bordered dt-responsive nowrap w-100">
            <tbody>
                <tr>
                    <td class="align-top fw-bold" style="white-space: nowrap; width: 1%;">General Note Assessor</td>
                    <td class="align-top">{!! $checkJar->last_reason_assessor ?? '-' !!}</td>
                    @if(in_array(Auth::user()->role, ['Assessor Main Dealer', 'PIC NOS MD']))
                    <td class="align-top" style="white-space: nowrap; width: 1%;">
                        @if(Auth::user()->role == 'Assessor Main Dealer' && $checkJar->status === 2)
                ...
                <tr>
                    <td class="align-top fw-bold" style="white-space: nowrap; width: 1%;">Last Note PIC NOS MD</td>
                    <td class="align-top">
                    ...
                    @if(in_array(Auth::user()->role, ['Assessor Main Dealer', 'PIC NOS MD']))
                    <td class="align-top" style="white-space: nowrap; width: 1%;">
                        @if(Auth::user()->role == 'PIC NOS MD' && $checkJar->status === 3)
